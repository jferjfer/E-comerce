...
export default function ProductoDetallePage() {
  ...
  const cargarProducto = async () => {
    ...
    try {
      ...
      metaPixel.viewContent({ id: prod.id?.toString() || '', nombre: prod.nombre || '', precio: prod.precio || 0, categoria: prod.categoria || '' })
          ...
          <div className="flex flex-col gap-4">
            ...
            {producto.en_stock && producto.precio >= 50000 && (
              <div className="flex items-center gap-2.5 px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-xl">
                <span className="text-sm text-gray-600">Págalo en cuotas con</span>
