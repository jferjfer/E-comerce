          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-3 py-2 pr-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-primary ${errores.password ? 'border-red-500' : 'border-gray-300'}`}
              ...
              >
                <i className={`fas ${mostrarPassword ? 'fa-eye-slash' : 'fa-eye'} text-sm`}></i>
              </button>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-3 py-2 pr-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400 ${errores.confirmar_password ? 'border-red-500' : 'border-gray-300'}`}
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600"
                >
                  <i className={`fas ${mostrarConfirmar ? 'fa-eye-slash' : 'fa-eye'} text-sm`}></i>
                </button>
              </div>
