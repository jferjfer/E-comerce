"""
Generador Nota Crédito UBL 2.1 — DIAN Colombia
Basado EXACTAMENTE en CreditNote.xml oficial DIAN.

Diferencias clave vs factura:
  - CustomizationID = "11"
  - ProfileID = "DIAN 2.1"  (sin sufijo)
  - Cliente AdditionalAccountID="1" con PhysicalLocation + PartyLegalEntity + Contact
  - 3 TaxTotal: IVA(01), ICA(03), INC(04)
  - CreditNoteTypeCode = "91"
  - CreditNoteLine en vez de InvoiceLine
"""
import hashlib
...
def generar_nota_credito(numero, factura_referencia, cufe_factura, fecha_factura,
    ...
    # UBLExtensions — SIN InvoiceControl (notas no lo tienen)
    ...
    etree.SubElement(root, f"{CBC}ProfileID").text          = "DIAN 2.1: Nota Crédito de Factura Electrónica de Venta"
    ...
    for i, l in enumerate(lineas, 1):
        ...
        etree.SubElement(line, f"{CBC}CreditedQuantity",
