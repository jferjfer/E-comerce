...
db.productos.insertMany([
  ...
  },
  {
    ...
    fecha_actualizacion: new Date('2024-01-02')
  },
  {
    _id: 'prod_003',
    ...
    fecha_actualizacion: new Date('2024-01-03')
  },
  {
    _id: 'prod_004',
    nombre: 'Blazer Elegante Mujer',
    descripcion: 'Blazer clásico para oficina y eventos formales',
    descripcion_larga: 'Blazer elegante de corte clásico, perfecto para el ambiente profesional. Confeccionado en tela de alta calidad con forro interior.',
    precio: 129.99,
    precio_oferta: 99.99,
    categoria_id: 'cat_001',
    marca: 'ProfessionalWear',
    sku: 'BLAZ001M',
    codigo_barras: '123456789004',
    imagenes: [
    ...
    variantes: [
      { nombre: 'Talla', opciones: ['XS', 'S', 'M', 'L', 'XL'] },
      { nombre: 'Color', opciones: ['Negro', 'Azul Marino', 'Gris', 'Beige'] }
    ],
    tendencia_moda: 'profesional',
    activo: true,
    destacado: true,
    puntuacion_promedio: 4.6,
    total_resenas: 67,
    fecha_creacion: new Date('2024-01-04'),
    fecha_actualizacion: new Date('2024-01-04')
  },
  {
    _id: 'prod_005',
    nombre: 'Sneakers Urbanos',
    descripcion: 'Zapatillas deportivas cómodas para uso diario',
    descripcion_larga: 'Sneakers modernos con suela de goma antideslizante y plantilla acolchada. Ideales para caminar y actividades casuales.',
    precio: 89.99,
    precio_oferta: 69.99,
    categoria_id: 'cat_002',
    marca: 'UrbanStep',
    sku: 'SNEAK001',
    codigo_barras: '123456789005',
    imagenes: [
    ...
    variantes: [
      { nombre: 'Talla', opciones: ['38', '39', '40', '41', '42', '43', '44'] },
      { nombre: 'Color', opciones: ['Blanco/Negro', 'Todo Negro', 'Blanco/Azul'] }
    ],
    tendencia_moda: 'deportiva',
    activo: true,
    destacado: false,
    puntuacion_promedio: 4.3,
    total_resenas: 124,
    fecha_creacion: new Date('2024-01-05'),
    fecha_actualizacion: new Date('2024-01-05')
  }
]);
...
db.resenas.insertMany([
  {
    ...
    usuario_id: 2,
    puntuacion: 5,
    titulo: 'Vestido hermoso',
    comentario: 'El vestido es precioso, la tela es de buena calidad y el estampado floral es muy elegante. Perfecto para eventos especiales.',
    verificada: true,
    util_positivos: 12,
    util_negativos: 1,
